...
export const notificationTypeEnum = pgEnum('notification_type', ['intelligence', 'system', 'achievement']);
...
export const notifications = pgTable(
  ...
  (table) => [
    ...
    index('notifications_user_id_created_at_idx').on(table.user_id, table.created_at),
  ]
);