...
export const intelligenceCategoryEnum = pgEnum('intelligence_category', ['launch', 'satellite', 'industry', 'research', 'environment']);
export const intelligenceLevelEnum = pgEnum('intelligence_level', ['free', 'advanced', 'professional']);
